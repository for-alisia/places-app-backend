...
// Get Place by Id (/api/places/:id, GET)
const getPlaceById = async (req, res, next) => {
  ...
  try {
    ...
    return next(new HttpError("Couldn't find a place in the database", 500));
  }
...
const getPlacesByUserId = async (req, res, next) => {
  ...
  try {
    ...
    return next(
      new HttpError("Couldn't retrieve data from database, try again", 500)
    );
  }
...
// Create new place (/api/places, POST)
...
// Update place (/api/places/:pid, PATCH)
